...
> Spec Kit generates changes across `Task.java`, `TaskService.java`, `TaskController.java`, and `index.html`.
...
| Item                 | Description                                                                           |
| -------------------- | ------------------------------------------------------------------------------------- |
| **Priority Support** | Added `priority` field across model, service, controller, and UI.                     |
